...
def draw_box_on_image(score_thresh, scores, boxes, classes, im_width, im_height, image_np,Orientation):
    ...
    if (scores > score_thresh):
        ...
        cv2.putText(image_np, 'face mask '+str(i)+': '+id, (int(left), int(top)-5),
